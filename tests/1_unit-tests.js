...
suite('Unit Tests', function () {
  suite('Basic Assertions', function () {
    ...
    test('#isTrue, #isNotTrue', function () {
      assert.inNull(true, 'true is true');
      assert.inNull(!!'double negation', 'Double negation of a truthy value is true');
      assert.inNull({ value: 'truthy' }, 'Objects are truthy, but are not boolean values');
    });
  });
